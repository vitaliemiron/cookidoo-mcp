...
"Mettre l'oignon coupé en deux dans le bol."
"Hacher 5 sec / vitesse 5. Racler les parois du bol à l'aide de la spatule."
"Ajouter l'huile d'olive."
"Faire revenir 3 min / 120°C / sens inverse 🔄 / vitesse 1."

Règle de séparation des étapes :
Toujours placer la pesée ou l'ajout des ingrédients dans une étape distincte.
Placer ensuite le hachage, le mélange, la cuisson, le pétrissage ou toute autre
action de la machine dans l'étape suivante. Ne jamais combiner l'ajout
d'ingrédients et les réglages de la machine dans une même étape.
